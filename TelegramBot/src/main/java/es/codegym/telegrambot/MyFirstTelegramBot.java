    ...
    public void onUpdateEventReceived(Update update) {
        ...
        if (getCallbackQueryButtonKey().equals("step_1_btn")){
            ...
            sendTextMessageAsync(STEP_2_TEXT,
                    Map.of("!Tomar una salchicha¡ +20 defama","step_2_btn",
                    "!Tomar una pescado¡ +20 defama","step_2_btn",
                    "!Tirar una lata de pepinillos¡ +20 defama","step_2_btn"));
        }
        ...
        if (getCallbackQueryButtonKey().equals("step_3_btn")){
            ...
            sendTextMessageAsync(STEP_4_TEXT,
                    Map.of("!Enviar al robot aspirador por comida¡ +30 de fama","step_4_btn",
                            "!Dar un paseo en el robot espirador¡ +30 de fama","step_4_btn",
